...
1. <a href="https://webspeedtest.cloudinary.com">Website Speed Test</a> to test the performance of the images on the page.
2. <a href="https://webpagetest.org">WebPageTest</a> to measure the load time of the page.
...
<a href="https://webspeedtest.cloudinary.com/results/180315_AS_9dc54a8880a3415473c2f1fd03ea3895">WebsiteSpeedTest</a> 
...
<a href = "https://webpagetest.org/result/180315_0S_8d8676cea9714fd1bf6820d70cb139c6/">WebPageTest</a>
...
By simply adding the q_50 parameter, Cloudinary generates an image at quality 50.  You can manually tweak the quality number for each image, or you can use the "q_auto" parameter to create an image with the maximum quality reduction that is imperceptible to the human eye.
...
Now, you can adjust each image individually for the width, but we can also do so programmatically.
